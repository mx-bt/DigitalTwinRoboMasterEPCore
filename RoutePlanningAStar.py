...
# python warehouseplan_and_route_planning_simplified.py

def route_planning(target_coordinates, start_coordinates):

    image_path = r"C:\Users\Max\Documents\MOM\ws2324\mbtm_dz_showcase\graphical_reps\warehouse_map.jpg"
    # Bild wird mit Hilfe einer visuellen Allokationsplattform für Rastergrafik-Inkorporation erstellt

    """
    x_box, y_box = liveposi[0] liveposi[1]

    ausdehnung_1 = x_box + 10
    ausdehnung_2 = x_box - 10
    ausdehnung_3 = y_box + 10
    ausdehnung_4 = y_box - 10
