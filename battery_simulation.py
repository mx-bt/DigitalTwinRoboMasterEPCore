def battery_life_fix(current_percentage):
    ...
    Nennspannung 4.2 V
    Batterielebensdauer (Standby) Ca. 100 Minuten
...
def battery_life_linear_reg():
    ...
    # plt.scatter(total_time, battery_percentage, label='Original Data')
    # plt.plot(fit_x, fit_y, label='Fitted Linear Regression', color='red')
